...
[.text-center]
image:https://csuci.sharepoint.com/:i:/r/sites/BrandAssets2026/Shared%20Documents/Approved%20Logos_Graphics/Approved%20Logo%20versions/Dolphin%20Spirit%20Mark/CSUCI_DSM-2C/CSUCI_DSM-2C.jpg?d=wfd64e8fc1e8f4fe9aa735e2015a4f8ba&csf=1&web=1&e=meEGLb[CSUCI Logo, 300, 100]
...
* *Lecture Meeting*: *[CONFIRM: days and times]*, *[CONFIRM: building and room]*
* *Lab Meeting*: *[CONFIRM: day and time]*, *[CONFIRM: lab room]*
* *Final Exam*: Tuesday, December 8, 2026, 7:00 PM-9:00 PM, Gateway Hall 3540, in person.

=== Course Format

This is a synchronous in-person class. We meet on campus for lecture and for a weekly lab session in a computer lab at the times listed above and in CI Learn.
...
* *Co-requisites*: None
* *General Education*: This course does not satisfy a General Education area. *[CONFIRM with Program Chair; if the course carries a GE designation, the corresponding GE Student Learning Outcomes must be added to this syllabus per SP 24-07 §I.E.]*
...
* *Financial commitments*: There are no course fees. All software used in this course is free and open source. The reference textbook listed below is recommended, not required; required readings are provided through CI Learn at no cost.
* *Off-campus travel*: None is required.
* *Attendance outside scheduled course time*: Two activities fall outside the regular class meeting pattern.
...
** Final project presentations occur during Week 15. If the number of projects requires time beyond the scheduled sessions, an additional session will be arranged with at least two weeks' notice.
...
This course meets in a computer lab and laptops are expected for lecture, labs, and in-class activities.
...
Because labs are hands-on and completed in the lab, absence from lab directly affects your ability to complete lab deliverables.
...
The following reference is recommended, not required, for students who want a structured textbook treatment of the material:
...
| Project proposal due | *[CONFIRM DATE]*, Week 8 (Oct 12-16) | Part of project grade
| Midterm exam | *[CONFIRM DATE]*, Week 8 (Oct 12-16) | 15%
| Final project presentations | *[CONFIRM DATE]*, Week 15 (Nov 30-Dec 5) | 20% with written deliverables
| Final exam | Tuesday, December 8, 2026, 7:00-9:00 PM, Gateway Hall 3540 | 15%
|===
...
*AIMA:* Ch. 2 (all) | Lab 1: Vacuum/Gridworld agents. | Normal week.
...
*AIMA:* Review Ch. 1-3, Ch. 5, Ch. 7, Ch. 8, and Ch. 12 selected readings. | *Midterm Review*: *[CONFIRM DATE]*. *Midterm Exam*: *[CONFIRM DATE]*. Project proposal due *[CONFIRM DATE]*. | Midterm review/exam week.
...
All labs are *hands-on Jupyter Notebook* based and designed for the weekly three-hour lab session.
