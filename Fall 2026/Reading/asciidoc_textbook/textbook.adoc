...
Regarding the search problems, they can be solved using a variety of search techniques, including but not limited to the five we study in COMP 469:
...
*Disclaimer*: Feel free to skip the following mathematical derivation. For COMP 469, you’re only required to know the result of the derivation summarized in the paragraph at the end of this section.
